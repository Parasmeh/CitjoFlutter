...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future trans() async {
    var translation =
        await translator.translate("Dart is very cool!", to: 'hi');
    print(translation);
  }
          ...
          Row(
            ...
            children: [
              Consumer<UserStore>(builder: (_, userStore, __) {
                return ProfilePic(
                  picUrl: userStore.currUser.profilePicUrl!,
                  name: '',
                );
              }),
              Consumer<UserStore>(builder: (_, userStore, __) {
                ...
                return Expanded(
                  child: Row(
                    ...
                    children: [
                      ProfileStatItem(
                          title: 'Posts',
                          count: userStore.currUserPosts != null
                              ? userStore.currUserPosts.length
                              : 0),
                      ProfileStatItem(
                          title: 'Subscribers',
                          count: userStore.currUser.subscribers != null
                              ? userStore.currUser.subscribers!.length
                              : 0),
                      ProfileStatItem(
                          title: 'Subscribed',
                          count: userStore.currUser.subscribed != null
                              ? userStore.currUser.subscribed!.length
                              : 0),
                    ],
                  ),
                );
            ...
            children: [
              ...
              Consumer<UserStore>(builder: (_, userStore, __) {
                ...
                return Column(
                  ...
                  children: [
                    Text(
                      userStore.currUser.username.toString(),
